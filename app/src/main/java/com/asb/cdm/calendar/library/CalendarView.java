...
import com.asb.cdm.CDMColors;
import com.asb.cdm.R;
import com.asb.cdm.calendar.library.CalendarHelper.Day;
...
public class CalendarView extends View {
    ...
    /*
    Constructors delegate to an eventual initCalendarView(context) call
     */
    ...
    /**
     * Updates the display to show the new calendarEvents
     *
     * @param calendarEvents The new events to be displayed
     */
    ...
    /**
     * Sets the selectedCellDay/Month to day and month values
     *
     * @param day   The day
    ...
    /**
     * Sets the current date based off of the milliseconds
     * and redraws the View
     * ????Why requestLayout call not in previous methods???
     *
     * @param milliseconds Since the epoch
     */
    ...
    /*
    Below lies the code that implements the functions needed to run when
    certain gestures occur on the CalendarView
     */
