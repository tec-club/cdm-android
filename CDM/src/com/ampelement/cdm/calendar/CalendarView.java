...
public class CalendarView extends View {
	...
	private void initCells() {
		...
		// build cells
		Rect Bound = new Rect(getPaddingLeft(), (int) (getPaddingTop() + WEEK_HEIGHT * 2 + mVerticalOffset - CELL_HEIGHT), CELL_WIDTH + getPaddingLeft(), (int) (WEEK_HEIGHT * 2 + getPaddingTop() + mVerticalOffset));
		for (int week = 0; week < mCells.length; week++) {
			for (int day = 0; day < mCells[week].length; day++) {
				...
				mCells[week][day] = new Cell(tmp[week][day].day, tmp[week][day].month, new Rect(Bound), CELL_TEXT_SIZE, false, textColor, backgroundColor);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(showDis, 0, mMonthBound.top + (WEEK_HEIGHT - (monthY / 4)), mTextPaint);
